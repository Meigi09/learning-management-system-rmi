...
public class InstructorMenu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("CURRICULUM");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SCHOOL, "Course/s"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PEOPLE, "Interraction"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_CONTACT_CALENDAR, "Assessment Management"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.GRADE, "Grading"));
        
        addTitle("REPORTS");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LINEAR_SCALE, "Progress Tracking"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ASSISTANT, "Resource Management"));
        
        addTitle("");       
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LOCK_OUTLINE, "Logout"));
