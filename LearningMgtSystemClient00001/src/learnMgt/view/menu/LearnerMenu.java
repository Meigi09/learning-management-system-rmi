...
public class LearnerMenu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("CURRICULUM");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SCHOOL, "Courses","Enrollment","Classes","Assessment"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PEOPLE, "Discussion Room"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.GRADE, "Grade Book"));
        
        addTitle("REPORTS");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LINEAR_SCALE, "Progress Tracking"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ASSISTANT, "FeedBack & Support"));
