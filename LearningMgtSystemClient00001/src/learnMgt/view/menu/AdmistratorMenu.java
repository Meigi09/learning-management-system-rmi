...
import javaswingdev.menu.MenuItem;
...
public class AdmistratorMenu extends JPanel {

    private int index = -1;
    private final List<EventMenuSelected> events = new ArrayList<>();

    public AdmistratorMenu() {
        init();
    }
    ...
    private void init() {
        ...
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.STORAGE, "Department"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.CONTROL_POINT, "Role"));
        addTitle("SECURITY");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SECURITY, "Tokens")); 
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SECURITY, "One Time Password")); 
        addTitle("SYSTEM");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SYSTEM_UPDATE, "System Configuration"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LOCK_OUTLINE, "Audit Log"));
        addTitle("");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SYSTEM_UPDATE, "Log Out"));
